import {
    ...
    Put,
    Delete,
    BadRequestException, UnauthorizedException, ConflictException, ForbiddenException, NotFoundException, HttpCode, HttpStatus
} from '@nestjs/common';
...
export class UserController {
    ...
    @Put(':pid')
    async updateUser(@Param('pid') pid: number, @Body() user: Partial<UserInterface>) {
